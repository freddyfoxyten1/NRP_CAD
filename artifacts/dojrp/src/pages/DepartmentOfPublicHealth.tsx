...
const DepartmentOfPublicHealth = () => {
  ...
  useEffect(() => {
    if (panelSection === 'personnel') {
      ...
      fetch('/api/dph/discord-roles', { headers: { accept: 'application/json' } })
        .then(r => r.ok ? r.json() : [])
          ...
          <div className="flex-1 px-5 py-7 sm:px-8 sm:py-9">
            ...
            <div className="mb-8">
              ...
              <p className="mt-2 text-sm text-[#8392aa]">
                {activeTab === 'personnel-roster'  ? 'Active personnel roster for the Department of Public Health.'
                ...
                : activeTab === 'vehicle-roster'    ? 'Vehicle inventory and assignments for the Department of Public Health.'
                : activeTab === 'equipment-roster'  ? 'Equipment inventory and assignments for the Department of Public Health.'
                        ...
                        <div className="space-y-5 px-8 py-6">
                          <div>
                            ...
                            <textarea value={indexInfoForm.description} rows={4}
                              placeholder="A brief overview of the Department of Public Health…"
