                ...
                <div key={item} className="contents lg:block lg:w-full">
                  ...
                  {item === 'Department of Transportation' && superAdmin && (
                    <button
                      ...
                      className="flex w-[240px] shrink-0 flex-col items-start justify-center gap-0.5 rounded-md border-l-2 border-transparent px-4 py-3 text-left text-sm font-semibold leading-snug transition-colors border-transparent text-[#a8b7cd] hover:bg-[#08111f] hover:text-white lg:w-full"
                    >
