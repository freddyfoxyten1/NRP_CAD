...
const DepartmentOfPublicSafety = () => {
  ...
  const departmentRankName = (m: RosterMember) => m.dps_rank || m.rank || null;
                                  ...
                                  <React.Fragment key={rankKey}>
                                    <tr
                                      ...
                                      <td colSpan={8 + rosterDivisions.length} className="px-5 py-2 pl-10">
                                        <div className="flex items-center gap-2 flex-wrap">
                                          {collapsed[rankKey]
                                            ? <ChevronRight className="h-3 w-3 text-[#6fa3ff] shrink-0" />
                                            : <ChevronDown className="h-3 w-3 text-[#6fa3ff] shrink-0" />}
